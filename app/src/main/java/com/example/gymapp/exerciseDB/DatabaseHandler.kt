...
class DatabaseHandler(context: Context) :
    ...
    companion object {
        ...
        private const val CREATE_EXERCISETABLE =
            "CREATE TABLE $TABLE_EXERCISES ( $COLUMN_EXERCISEID" +
        ...
        private const val CREATE_LINKINGTABLE =
            "CREATE TABLE $TABLE_LINKINGTABLE ( $COLUMN_WORKOUTID" +
    ...
    fun getExercises(WID: Int): ArrayList<Exercises> {
        val qry =
            "SELECT $TABLE_EXERCISES.$COLUMN_EXERCISEID, $COLUMN_EXERCISENAME FROM $TABLE_EXERCISES, $TABLE_LINKINGTABLE " +
...
//    TODO: Create methods for deleting entries
}